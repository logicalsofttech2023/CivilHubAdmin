...
const MachineryCategoryList = () => {
  ...
  let addcategorydata = () => {
    swal({
      title: "Machinery Category added Successfully",
      text: "Machinery Category inserted successfully",
      icon: "success",
      buttons: true,
    });
  };
  const categorydatahandle = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_service_category`,
        formData,
        options
      )
      .then((res) => {
        toast.success(res?.data?.msg || "Machinery Category Add Successfully");
        addcategorydata();
        getbannerlist();
      })
      .catch((error) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/all_service_category`,
        options
      )
      .then((res) => {
  ...
  let cetagoryedit = () => {
    navigate("/updateMachineryCategory");
  };
  ...
  let deletesubcategory = (item) => {
    swal({
      ...
      if (willDelete) {
        ...
        deletebannerimage();
        swal("Poof! Your Machinery category  has been deleted!", {
          icon: "success",
        });
      } else {
        swal("Your Machinery category is safe!");
      }
    });
  };
...
export default MachineryCategoryList;
