...
const IndividualBanner = () => {
  ...
  const handleAddBanner = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_individual_banner`,
        formData,
        options
      )
      .then((res) => {
        toast.success(res?.data?.msg || "Banner Add Successfully");
        addcategorydata();
        getBannerList();
      })
      .catch((error) => {
  ...
  let getBannerList = () => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/get_individual_banner`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  let cetagoryedit = () => {
    navigate("/updateIndividualBanner");
  };
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/delete_individual_banner`,
              bannerdata,
              options
            )
            .then((res) => {
                          ...
                          <div>
                            <div className="form-group  lang_form">
                              ...
                              <input
                                ...
                                placeholder="New Individual Banner"
                                required
                              />
                            </div>
                          </div>
