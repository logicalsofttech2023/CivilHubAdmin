...
const IndividualBlog = () => {
  ...
  const handleAddBlog = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_individual_blog`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getAllBlogs = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/all_individual_blog`, options)
      .then((res) => {
        console.log(res);
    ...
    swal({
      ...
      if (willDelete) {
        let handleDeleteBlogImage = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/individual_blog_deleted/${item}`,
              options
            )
            .then((res) => {
              getAllBlogs();
