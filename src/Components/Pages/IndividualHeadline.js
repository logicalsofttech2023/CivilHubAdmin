...
const IndividualHeadline = () => {
  ...
  const submitForm = (event) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/AddOrUpdateIndividualHeadline`,
        formData,
        options
      )
      .then((res) => {
  ...
  const getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/GetIndividualHeadline`,
        options
      )
      .then((res) => {
        console.log(res);
            ...
            <div className="dashboard-content">
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h1 className="h3 mb-0 text-dark">Individual Headline</h1>
                </div>
              </div>
...
export default IndividualHeadline;
