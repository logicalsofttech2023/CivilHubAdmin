...
const UpdateServiceSubCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/service_sub_cat_details/${categoryId}`,
        options
      )
      .then((res) => {
        setCategoryName(res.data.data?.title || "");
        setSelectedCategory(res.data.data?.servicecate_id || "");
        setPreviewImage(
          res.data.data?.image
  ...
  let getServiceCategoryList = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/all_bussiness_category`,
        options
      )
      .then((res) => {
  ...
  const handleUpdateCategory = (e) => {
    ...
    formData.append("servicecateId", categoryId);
    formData.append("servicecate_id", selectedCategory);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/update_service_sub_cat`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export default UpdateServiceSubCategory;
