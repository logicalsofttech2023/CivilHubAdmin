...
const UpdateWorkShopBanner = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/UpdateWorkShopBanner`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/WorkShopBannerDetails?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateWorkShopBanner;
