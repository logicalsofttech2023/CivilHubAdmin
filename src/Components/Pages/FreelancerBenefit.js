...
const FreelancerBenefit = () => {
  ...
  const handleAddData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_freelancer_benefit`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getAllFreelancerBenefits`,
        options
      )
      .then((res) => {
  ...
  let editData = (id) => {
    navigate("/updateFreelancerBenefit", { state: { id: id } });
  };
    ...
    swal({
      ...
      if (willDelete) {
        const deleteIcon = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/deleteFreelancerBenefit?id=${item}`,
              options
            )
            .then((res) => {
              getData();
...
export default FreelancerBenefit;
