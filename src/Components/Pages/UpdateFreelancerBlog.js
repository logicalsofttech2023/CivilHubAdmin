...
const UpdateFreelancerBlog = () => {
  ...
  const handleBlogUpdate = (e) => {
    ...
    formData.append("blogfreeId", blogId);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/freelancer_blog_update`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/freelancer_blog_details/${blogId}`,
        options
      )
      .then((res) => {
...
export default UpdateFreelancerBlog;
