...
const UpdateMarketPlaceBanner = () => {
  ...
  let getcategorydetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/market_banner_details/${category_id}`,
        options
      )
      .then((res) => {
  ...
  const editcetagory = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/update_market_banner`,
        formData,
        options
      )
      .then((res) => {
