...
const UpdateTenderSubCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/tender_sub_cate_details/${categoryId}`,
        options
      )
      .then((res) => {
        setCategoryName(res.data.data?.title || "");
        setSelectedCategory(res.data.data?.tendercat_id || "");
        setPreviewImage(
          res.data.data?.image
  ...
  const handleUpdateCategory = (e) => {
    ...
    formData.append("tendersubcatId", categoryId);
    formData.append("tendercat_id", selectedCategory._id);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/tender_sub_cate_update`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export default UpdateTenderSubCategory;
