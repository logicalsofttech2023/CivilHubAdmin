...
const MarketPlaceBanner = () => {
  ...
  const categorydatahandle = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_market_banner`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/all_market_banner`,
        options
      )
      .then((res) => {
        console.log("res", res);
  ...
  let cetagoryedit = () => {
    navigate("/UpdateMarketPlaceBanner");
  };
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/market_banner_delete`,
              bannerdata,
              options
            )
            .then((res) => {
                          ...
                          <div>
                            <div className="form-group  lang_form">
                              ...
                              <input
                                ...
                                placeholder="New Market Place Banner"
                                required
                              />
                            </div>
                          </div>
                        ...
                        >
                          <thead className="thead-light thead-50 text-capitalize">
                            <tr>
                              ...
                              {/* <th>Main Category </th> */}
                              <th>Market Place Banner Title</th>
                              <th>Date/Time</th>
                              <th>Status</th>
