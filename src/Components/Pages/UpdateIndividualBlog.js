...
const UpdateFreelancerBlog = () => {
  ...
  const handleBlogUpdate = (e) => {
    ...
    formData.append("blogindiiId", blogId);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/individusl_blog_updste`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/individual_blog_details/${blogId}`,
        options
      )
      .then((res) => {
