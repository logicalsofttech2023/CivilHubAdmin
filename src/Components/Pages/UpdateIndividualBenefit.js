...
const UpdateIndividualBenefit = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/updateIndividualBenefit?id=${id}`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getIndividualBenefitById?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateIndividualBenefit;
