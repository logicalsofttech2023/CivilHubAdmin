...
const FreelancerBlog = () => {
  ...
  const handleAddBlog = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_freelancer_blog`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getAllBlogs = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/all_freelancer_blog`,
        options
      )
      .then((res) => {
        console.log(res);
    ...
    swal({
      ...
      if (willDelete) {
        let handleDeleteBlogImage = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/freelancer_blog_delete/${item}`,
              options
            )
            .then((res) => {
              getAllBlogs();
