...
const UpdateBusinessCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/bussiness_cate_details/${categoryId}`,
        options
      )
      .then((res) => {
  ...
  const handleUpdateCategory = (e) => {
    ...
    formData.append("bussinesscatId", categoryId);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/update_bussiness_cate`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
