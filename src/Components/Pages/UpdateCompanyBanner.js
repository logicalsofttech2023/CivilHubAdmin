...
const UpdateCompanyBanner = () => {
  ...
  let getcategorydetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/company_banner_details/${category_id}`,
        options
      )
      .then((res) => {
  ...
  const editcetagory = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/update_company_banner`,
        formData,
        options
      )
      .then((res) => {
