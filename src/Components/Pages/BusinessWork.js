...
const BusinessWork = () => {
  ...
  const handleAddData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/AddBusinessWork`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getAllBusinessWorks`,
        options
      )
      .then((res) => {
  ...
  let editData = (id) => {
    navigate("/updateBusinessWork", { state: { id: id } });
  };
    ...
    swal({
      ...
      if (willDelete) {
        const deleteIcon = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/deleteBusinessWork?id=${item}`,
              options
            )
            .then((res) => {
              getData();
