...
const CompanyBenefit = () => {
  ...
  const handleAddData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_company_benefit`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getAllCompanyBenefits`,
        options
      )
      .then((res) => {
  ...
  let editData = (id) => {
    navigate("/updateCompanyBenefit", { state: { id: id } });
  };
    ...
    swal({
      ...
      if (willDelete) {
        const deleteIcon = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/deleteCompanyBenefit?id=${item}`,
              options
            )
            .then((res) => {
              getData();
