...
const IndividualBenefit = () => {
  ...
  const handleAddData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_individual_benefit`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getAllIndividualBenefits`,
        options
      )
      .then((res) => {
  ...
  let editData = (id) => {
    navigate("/updateIndividualBenefit", { state: { id: id } });
  };
    ...
    swal({
      ...
      if (willDelete) {
        const deleteIcon = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/deleteIndividualBenefit?id=${item}`,
              options
            )
            .then((res) => {
              getData();
...
export default IndividualBenefit;