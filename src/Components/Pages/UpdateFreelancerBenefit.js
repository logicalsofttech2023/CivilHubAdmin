...
const UpdateFreelancerBenefit = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/updateFreelancerBenefit?id=${id}`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getFreelancerBenefitById?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateFreelancerBenefit;
