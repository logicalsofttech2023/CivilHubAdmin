...
const UpdateJobPositionSubCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/JobPositionSubCategoryDetails?id=${categoryId}`,
        options
      )
      .then((res) => {
        setCategoryName(res.data.data?.name || "");
        setSelectedCategory(res.data.data?.jobPositionCategoryId || "");
        setPreviewImage(
          res.data.data?.image
  ...
  const handleUpdateCategory = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/UpdateJobPositionSubCategory`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      .then((res) => {
        ...
        showSuccessMessage();
        setTimeout(() => {
          navigate("/jobPositionSubCategory");
        }, 2000);
      })
      .catch((error) => {
            ...
            <div className="d-flex flex-wrap gap-2 align-items-center mb-3">
              <h2 className="h1 mb-0">
                <img
                  ...
                  alt="icon"
                />
                Update Job Position Sub Category
              </h2>
            </div>
...
export default UpdateJobPositionSubCategory;
