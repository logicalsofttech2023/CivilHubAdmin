...
const UpdateServiceProviderCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/provider_service_cat_details/${categoryId}`,
        options
      )
      .then((res) => {
  ...
  const handleUpdateCategory = (e) => {
    ...
    formData.append("serviceprocatId", categoryId);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/update_service_provider_cat`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      .then((res) => {
        ...
        showSuccessMessage();
        setTimeout(() => {
          navigate("/serviceProviderCategory");
        }, 2000);
      })
      .catch((error) => {
...
export default UpdateServiceProviderCategory;