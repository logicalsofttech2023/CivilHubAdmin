...
const UpdateFreelancerBlog = () => {
  ...
  const handleBlogUpdate = (e) => {
    ...
    formData.append("blogcompanyId", blogId);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/company_blog_update`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/company_blog_details/${blogId}`,
        options
      )
      .then((res) => {
