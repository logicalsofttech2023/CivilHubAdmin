...
const UpdateTenderCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/tender_cate_details/${categoryId}`,
        options
      )
      .then((res) => {
  ...
  const handleUpdateCategory = (e) => {
    ...
    formData.append("tendercatId", categoryId);
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/tender_cate_update`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
