...
const AddFreelancer = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!freelancerSubCategoryId)
      newErrors.freelancerSubCategoryId = "Please select subcategory";
    if (!skillIds.length)
      newErrors.skillIds = "Please select at least one skill";
    setErrors(newErrors);
  ...
  let getSkills = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/admin_all_skills`,
        options
      )
      .then((res) => {
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-6">
                          ...
                          >
                            ...
                            <Select
                              ...
                              label="Account Type"
                            >
                              <MenuItem selected value="Freelancer">
                                Freelancer
                              </MenuItem>
                            </Select>
                            {errors.accountType && (
                        ...
                        <div className="col-lg-6">
                          ...
                          >
                            ...
                            >
                              {freelancerSubCategory?.map((cat) => (
                                <MenuItem key={cat._id} value={cat._id}>
                                  <Checkbox
                                    checked={freelancerSubCategoryId.includes(
                                      cat._id
                                    )}
                                  />
                            ...
                            {errors.freelancerSubCategoryId && (
                              <FormHelperText error>
                                {errors.freelancerSubCategoryId}
                              </FormHelperText>
                            )}
                        ...
                        <div className="col-lg-12">
                          <div className="form-group lang_form">
                            <label className="title-color">Skill ID</label>
                            <FormControl
                              sx={{ m: 1, width: "100%" }}
                              error={!!errors.skillIds}
                            >
                              <InputLabel id="skills-multi-select-label">
                                Select Skills
                              </InputLabel>
                              <Select
                                labelId="skills-multi-select-label"
                                id="skills-multi-select"
                                multiple
                                value={skillIds}
                                  ...
                                  >
                                    {selected.map((value) => {
                                      ...
                                      return (
                                        <Chip
                                          key={value}
                                          label={selectedSkill?.name || value}
                                        />
                                      );
                                    })}
                                  </Box>
                              ...
                              >
                                {skillsList?.map((skill) => (
                                  <MenuItem key={skill._id} value={skill._id}>
                                    <Checkbox
                                      checked={skillIds.indexOf(skill._id) > -1}
                                    />
                        ...
                        <div className="col-lg-6 mt-3">
                          <Typography>Resume (Optional)</Typography>
                          <Button
                            variant="outlined"
                            component="label"
                            fullWidth
                          ...
                          {resume && renderFilePreview(resume, setResume)}
                        </div>
