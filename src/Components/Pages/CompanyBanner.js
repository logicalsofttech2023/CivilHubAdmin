...
const CompanyBanner = () => {
  ...
  const handleAddBanner = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_company_banner`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getBannerList = () => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/get_company_banner`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/delete_company_banner`,
              bannerdata,
              options
            )
            .then((res) => {
                          ...
                          <div>
                            <div className="form-group  lang_form">
                              ...
                              <input
                                ...
                                placeholder="New Company Banner"
                                required
                              />
                            </div>
                          </div>
