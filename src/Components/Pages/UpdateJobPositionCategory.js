...
const UpdateJobPositionCategory = () => {
  ...
  const fetchCategoryDetails = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/JobPositionCategoryDetails?id=${categoryId}`,
        options
      )
      .then((res) => {
  ...
  const handleUpdateCategory = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/UpdateJobPositionCategory`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export default UpdateJobPositionCategory;