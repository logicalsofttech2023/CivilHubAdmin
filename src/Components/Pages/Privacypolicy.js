...
const Privacypolicy = () => {
  ...
  const submitForm = (event) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_KEY}admin/api/update_privacy/${id}`,
        dataAbout,
        options
      )
      .then((res) => {
        toast.success(
          res?.data?.msg || "Privacy and Policy Data Updated Successfully"
        );
        getAbout();
      })
      .catch((error) => {});
  ...
  const submitForm1 = (event) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_KEY}admin/api/update_privacy/${id1}`,
        dataAbout,
        options
      )
      .then((res) => {
  ...
  const submitForm2 = (event) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_KEY}admin/api/update_privacy/${id2}`,
        dataAbout,
        options
      )
      .then((res) => {
        getAbout2();
        toast.success(
          res?.data?.msg || "Privacy and Policy Updated Successfully"
        );
      })
  ...
  const submitForm3 = (event) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_KEY}admin/api/update_privacy/${id3}`,
        dataAbout,
        options
      )
      .then((res) => {
  ...
  const getAbout = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/get_privacy`, options)
      .then((res) => {
  ...
  const getAbout2 = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/get_privacy`, options)
      .then((res) => {
        const businessData = res.data.data.find(
          (item) => item.type === "Business"
        );
        if (businessData) {
          setAboutData((prev) => [
            ...prev.filter((item) => item.type !== "Business"),
            businessData,
          ]);
          setTitle2(businessData.title || "");
          setText2(businessData.description || "");
          setid2(businessData._id || "");
        }
      })
      .catch((error) => console.log(error));
  };
  ...
  const getAbout3 = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/get_privacy`, options)
      .then((res) => {
        const individualData = res.data.data.find(
          (item) => item.type === "Individual"
        );
        if (individualData) {
          setAboutData((prev) => [
            ...prev.filter((item) => item.type !== "Individual"),
            individualData,
          ]);
          setTitle3(individualData.title || "");
          setText3(individualData.description || "");
          setid3(individualData._id || "");
        }
      })
      .catch((error) => console.log(error));
  };
          ...
          <div className="mt-3 mb-5">
            ...
            <div className="row mb-5">
              <div className="col-md-12 mb-3">
                <div className="card">
                  <div className="card-header justify-content-center">
                    <h2 className="mb-0">Privacy Policy for Company</h2>
                  </div>
              ...
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header justify-content-center">
                    <h2 className="mb-0">Privacy Policy for Freelancer</h2>
                  </div>
              ...
              <div className="col-md-12 mb-3">
                <div className="card">
                  <div className="card-header justify-content-center">
                    <h2 className="mb-0">Privacy Policy for for Business</h2>
                  </div>
              ...
              <div className="col-md-12 mb-3">
                <div className="card">
                  <div className="card-header justify-content-center">
                    <h2 className="mb-0">Privacy Policy for for Individual</h2>
                  </div>
