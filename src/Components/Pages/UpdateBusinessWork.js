...
const UpdateBusinessWork = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/updateBusinessWork?id=${id}`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getBusinessWorkById?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateBusinessWork;
