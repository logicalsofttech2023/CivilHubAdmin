...
const ProductCategory = () => {
  ...
  const categorydatahandle = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_market_category`,
        formData,
        options
      )
      .then((res) => {
        toast.success(res?.data?.msg || "Product Category Add Successfully");
        addcategorydata();
        getbannerlist();
      })
      .catch((error) => {
  ...
  let getbannerlist = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/all_market_category`,
        options
      )
      .then((res) => {
  ...
  let cetagoryedit = () => {
    navigate("/updateProductCategory");
  };
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/market_category_delete`,
              data,
              options
            )
            .then((res) => {
