...
const TendorBlogsList = () => {
  ...
  let addBlogData = () => {
    swal({
      title: "Tendor Blog added Successfully",
      text: "Tendor Blog inserted sucessfully",
      icon: "success",
      buttons: true,
    });
  };
  const handleAddBlog = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/admin_add_tendor_blogs`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getAllBlogs = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/admin_all_tendor_blogs`,
        options
      )
      .then((res) => {
        console.log(res);
    ...
    swal({
      ...
      if (willDelete) {
        let handleDeleteBlogImage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/admin_tendor_blogs_delete`,
              bannerdata,
              options
            )
            .then((res) => {
...
export default TendorBlogsList;
