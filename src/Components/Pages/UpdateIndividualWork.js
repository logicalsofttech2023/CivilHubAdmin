...
const UpdateIndividualWork = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/updateIndividualWork?id=${id}`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getIndividualWorkById?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateIndividualWork;
