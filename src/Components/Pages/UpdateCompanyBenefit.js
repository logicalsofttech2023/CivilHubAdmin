...
const UpdateCompanyBenefit = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/updateCompanyBenefit?id=${id}`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getCompanyBenefitById?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateCompanyBenefit;
