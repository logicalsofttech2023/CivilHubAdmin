...
const CompanyWork = () => {
  ...
  const handleAddData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/AddCompanyWork`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getAllCompanyWorks`,
        options
      )
      .then((res) => {
  ...
  let editData = (id) => {
    navigate("/updateCompanyWork", { state: { id: id } });
  };
    ...
    swal({
      ...
      if (willDelete) {
        const deleteIcon = () => {
          ...
          axios
            .get(
              `${process.env.REACT_APP_API_KEY}admin/api/deleteCompanyWork?id=${item}`,
              options
            )
            .then((res) => {
              getData();
