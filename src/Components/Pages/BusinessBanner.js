...
const BusinessBanner = () => {
  ...
  const handleAddBanner = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/add_business_banner`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getBannerList = () => {
    axios
      .get(`${process.env.REACT_APP_API_KEY}admin/api/get_business_banner`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
    ...
    swal({
      ...
      if (willDelete) {
        let deletebannerimage = () => {
          ...
          axios
            .post(
              `${process.env.REACT_APP_API_KEY}admin/api/delete_business_banner`,
              bannerdata,
              options
            )
            .then((res) => {
                          ...
                          <div>
                            <div className="form-group  lang_form">
                              ...
                              <input
                                ...
                                placeholder="New Business Banner"
                                required
                              />
                            </div>
                          </div>
