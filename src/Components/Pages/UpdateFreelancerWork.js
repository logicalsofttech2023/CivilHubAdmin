...
const UpdateFreelancerWork = () => {
  ...
  const handleUpdateData = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_API_KEY}admin/api/updateFreelancerWork?id=${id}`,
        formData,
        options
      )
      .then((res) => {
  ...
  let getData = () => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_KEY}admin/api/getFreelancerWorkById?id=${id}`,
        options
      )
      .then((res) => {
...
export default UpdateFreelancerWork;
